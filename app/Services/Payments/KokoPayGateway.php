...
class KokoPayGateway implements PaymentGatewayInterface
{
    ...
    {
        $secret = (string) config('services.koko_pay.webhook_secret');
        ...
        return [
            'provider' => 'koko_pay',
            'verified' => $verified,
            'event_id' => (string) ($payload['event_id'] ?? $payload['transaction_id'] ?? Str::uuid()),
